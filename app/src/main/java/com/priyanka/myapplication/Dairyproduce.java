...
public class Dairyproduce extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dairyproduce);
                ...
                if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    add.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(Dairyproduce.this, Admin.class);
                            i.putExtra("keyroot","Dairyproduce");
                            startActivity(i);
                        }
                    });
                }
        ...
        mdatabase = FirebaseDatabase.getInstance().getReference().child("Dairyproduce");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<gtr, Fruits.BlogViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<gtr, Fruits.BlogViewholder>(gtr.class,R.layout.design2,Fruits.BlogViewholder.class,mdatabase) {
            @Override
            protected void populateViewHolder(Fruits.BlogViewholder viewHolder, gtr model, int position) {
                final String pskey = getRef(position).getKey();
                viewHolder.setName(model.getName());
                viewHolder.setHomestayPic(getApplicationContext(), model.getProducePic());
                ...
                viewHolder.view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Dairyproduce.this, "Loading details...", Toast.LENGTH_LONG).show();
                        mdatabase.child(pskey).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                Intent intent = new Intent(Dairyproduce.this, Main2Activity.class);
