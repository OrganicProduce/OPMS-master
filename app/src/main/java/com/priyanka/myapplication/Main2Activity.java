    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mref.child(message).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                aaddress=(String) dataSnapshot.child("Available").getValue();
                aprice=(String) dataSnapshot.child("Price").getValue();
                aimage=(String) dataSnapshot.child("ProducePic").getValue();
...
// Hide progress bar on successful load
                ...
                hname.setText(aname);
                haddress.setText("Available"+aaddress+"Kg");
                hprice.setText("Rs"+aprice+"/-");
