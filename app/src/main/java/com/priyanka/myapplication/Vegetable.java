...
public class Vegetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    add.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            Intent i = new Intent(Vegetable.this, Admin.class);
                            i.putExtra("keyroot","Vegetable");
                            startActivity(i);
                        }
                    });
                }
        ...
        mdatabase = FirebaseDatabase.getInstance().getReference().child("Vegetable");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<gtr, BlogViewholder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<gtr, BlogViewholder>(gtr.class,R.layout.design2,BlogViewholder.class,mdatabase) {
            ...
            protected void populateViewHolder(BlogViewholder viewHolder, gtr model, int position) {
                ...
                viewHolder.setProducePic(getApplicationContext(), model.getProducePic());
               // viewHolder.setHomeaddress(model.getHomeaddress());
                ...
                viewHolder.view.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(Vegetable.this, "Loading details...", Toast.LENGTH_LONG).show();
                        mdatabase.child(pskey).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(DataSnapshot dataSnapshot) {
                               Intent intent = new Intent(Vegetable.this, Main2Activity.class);
                                intent.putExtra("message", pskey);
                                intent.putExtra("keyroot","Vegetable");
    ...
    public static class BlogViewholder extends RecyclerView.ViewHolder {
        ...
        public void setProducePic(Context ctx, String image) {
